...
class Post
{
    ...
    public function create( $post = array() )
    {
        ...
        try{
            ...
            $statement = "INSERT INTO `posts` ( `title`, `status`, `ACL`, `content`, `username`)
                          ...
                          title=values(title), status=values(status), ACL=values(ACL), content=values(content),  username=values(username) ";
    ...
    {        
        try{
            ...
            $statement = "INSERT INTO `posts` (`postid`, `title`, `status`, `ACL`, `content`, `date`, `username`)
                          ...
                          ON DUPLICATE KEY UPDATE
                          postid=values(postid), title=values(title), status=values(status), ACL=values(ACL), content=values(content), date=values(date), username=values(username) ";
    ...
    public function delete() {
        try{
            ...
            $statement = "UPDATE `tow`.`posts` SET `status` = 'deleted' WHERE `postid` = ?;";
